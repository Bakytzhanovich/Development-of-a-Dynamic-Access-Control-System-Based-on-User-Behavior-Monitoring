...
const translations = {
  en: {
    ...
    'dashboard.title': 'My Session Security',
    'dashboard.demoScenario': 'Demo Scenario Control Panel',
    'dashboard.adminOnly': 'Admin only',
    'dashboard.engineTestPanel': 'Behavioral Engine Test Panel',
    'dashboard.triggerDetection': 'trigger detection modules',
    ...
    'dashboard.stepUpRequired': 'Step-up authentication required',
    'dashboard.stepUpHint': 'Verify your identity to restore full access to sensitive data.',
  ...
  ru: {
    ...
    'dashboard.title': 'Безопасность моего сеанса',
    'dashboard.demoScenario': 'Панель управления демо-сценарием',
    'dashboard.adminOnly': 'Только для администратора',
    'dashboard.engineTestPanel': 'Тестовая панель поведенческого движка',
    'dashboard.triggerDetection': 'запустить модули детекции',
    'dashboard.stepUpRequired': 'Требуется дополнительная аутентификация',
    'dashboard.stepUpHint': 'Подтвердите личность, чтобы восстановить полный доступ к чувствительным данным.',
  ...
  kk: {
    ...
    'dashboard.title': 'Менің сеансымның қауіпсіздігі',
    'dashboard.demoScenario': 'Демо сценарий басқару тақтасы',
    'dashboard.adminOnly': 'Тек әкімші үшін',
    'dashboard.engineTestPanel': 'Мінез-құлық қозғалтқышының сынақ тақтасы',
    'dashboard.triggerDetection': 'детекция модульдерін іске қосу',
    'dashboard.stepUpRequired': 'Қосымша аутентификация қажет',
    'dashboard.stepUpHint': 'Құпия деректерге толық қол жеткізуді қалпына келтіру үшін жеке басыңызды растаңыз.',
